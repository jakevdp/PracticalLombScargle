...
With this in mind, we can be assured that evaluating the transform in the
range $[-(2T)^{-1}, (2T)^{-1}]$ is sufficient to capture all the relevant
frequency information: everything else will simply be an alias of what appears
within that range.
