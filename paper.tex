...
\begin{figure}[ht]
  ...
  \caption{Visualization of the Convolution theorem as used to compute the
    result in \fig{convolution}. The key is that the Fourier transform of
    a convolution is the pointwise product of the two Fourier transforms.
    \figlabel{convolution_theorem}}
\end{figure}

Likewise, the Fourier transform of a product is a convolution of the transforms:
\begin{equation}
