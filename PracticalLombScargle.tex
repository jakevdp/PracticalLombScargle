...
In cases where the single-term power spectrum is itself very noisy, these
additional aliases can quickly wash-out any gains from the more complicated
model.
Consider \fig{LINEAR-multiterm}, in which the $n=3$ model leads to very large
noise at the low-frequency end. In this case, spurious periodogram peaks due
to coincidences of such aliases may become problematic for even moderately
noisy models.
