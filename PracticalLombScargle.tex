...
\begin{enumerate}
  ...
  \item What is the largest frequency (i.e. Nyquist-like limit) that such an analysis is sensitive to?
...
\end{enumerate}
Quantitative answers to these sorts of questions are discussed in various textbooks and review papers, but I have not come across any single concise reference that gives a good intuition for how to think about such questions.
...
Such reciprocity comes up in many diverse applications of Fourier analysis,
from wavelet transforms to music to quantum mechanics.
For our purposes, this feature will turn out to be quite important as we
push further in understanding the Lomb-Scargle Periodogram.
...
\begin{equation}
  g_{obs}(t) = g(t)W(t),
\end{equation}
and its Fourier transform is a convolution:
\begin{equation}
...
Here we consider a periodic function observed only within the window $[-3, 3]$.
...
rate of $f_0 = 1/T$, we can only fully recover the freuqency information
