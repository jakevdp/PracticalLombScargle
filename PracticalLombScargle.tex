...
peak \citep{Jaynes1987, Bretthorst88}---and this introduces some first-order
dependence on the number of samples and their signal-to-noise ratio rather
than the peak width alone.

We have motivated from the Fourier window discussions that peak width
scales with the observational baseline; the surprising result is that to
...
than the precision of frequency estimation.
...
Because of this, if you insist on reporting frequency errorbars derived from
...
periodogram reveals a period of $2.58014 \pm 0.00004$ hours.
