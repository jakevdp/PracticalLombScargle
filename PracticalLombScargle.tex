...
it would speak to these questions as well.
...
observing window---is via simulated data.
In fact, this type of simulation is a vital component of most current and
future time-domain surveys that seek to catalog periodic objects
\citep[see, e.g.][]{opsim1, opsim2, Ivezic08LSST}
\todo{refs for SDSSII, Kepler, PanSTARRS, Gaia}.
