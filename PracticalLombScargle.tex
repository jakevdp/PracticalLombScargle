...
\todo{how to compute empirical window functions}
...
\subsection{Computing the Window Power}
\sectlabel{computing-window-power}
The discussion of \sect{window-functions} highlighted the importance of
examining the window function
