...
recommendations contained in these pages, along with a somewhat opinionated
and iconoclastic post-script for further thought.
...
it should serve as a gentle reminder of the kinds of issues you should keep
in mind when using the method in practice.

\subsection{Other Measures of Periodicity}
\todo{fill this in}
...
%One clear advantage retained by both the Lomb-Scargle and Schuster periodograms
%is that they are quite efficient compared with more sophisticated approaches
%to periodic analysis based on more constrained generative models or Bayesian
